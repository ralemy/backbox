...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("01 Should Navigate from Main to Settings Page")]
        [NUnit.Framework.CategoryAttribute("Settings_Page")]
        public virtual void _01ShouldNavigateFromMainToSettingsPage()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("01 Should Navigate from Main to Settings Page", new string[] {
                        "Settings_Page"});
#line 6
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("02 Should have a switch to Use Https")]
        [NUnit.Framework.CategoryAttribute("Settings_Page")]
        public virtual void _02ShouldHaveASwitchToUseHttps()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("02 Should have a switch to Use Https", new string[] {
                        "Settings_Page"});
#line 13
this.ScenarioSetup(scenarioInfo);
#line 14
...
#line 16
    testRunner.And("I record the state of the UseHttps Setting", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 17
    testRunner.When("I tap the switch", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 18
    testRunner.Then("the UseHttps Setting will toggle", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
    }
